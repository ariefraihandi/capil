  ...
  <ul class="navbar-nav flex-row align-items-center ms-auto">
    ...
    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
      <div class="avatar avatar-online">
          <img src="{{ asset('assets/img/logo/' . $users->detail->image) }}" alt="{{ $users->detail->name }}" class="avatar-img w-px-40 h-200 rounded-circle" />
      </div>
  </a>
        ...
        <li>
          <a class="dropdown-item" href="#">
            <div class="d-flex">
              <div class="flex-shrink-0 me-3">
                <div class="avatar avatar-online">
                  <img src="{{ asset('assets/img/logo/' . $users->detail->image) }}" alt="{{ $users->detail->name }}" class="w-px-40 h-200 rounded-circle" />
                </div>
              </div>
              <div class="flex-grow-1">
